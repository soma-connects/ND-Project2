<x-app-layout title="Capsules" bodyclass="cap">
    <div class="container px-4 py-8">
        <h2 class="text-4xl font-bold mb-8 mt-5 btn text-accent text-center font-playfair">Capsules</h2>
        ...
        <div class="sort-controls">
            <form action="{{ route('cap') }}" method="GET">
