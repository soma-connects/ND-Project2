<x-app-layout title="Shrooms" bodyclass="shroom">
    <div class="container px-4 py-8">
        <h2 class="text-4xl font-bold mb-8 mt-5 btn text-accent text-center font-playfair">Shrooms</h2>
        ...
        <div class="sort-controls">
            <form action="{{ route('shroom') }}" method="GET">
